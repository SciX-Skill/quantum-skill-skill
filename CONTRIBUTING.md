...
Welcome! This guide explains how to contribute to quantum-skill.
...
```bash
git clone https://github.com/<YOUR_USERNAME>/quantum-skill-skill.git
cd quantum-skill-skill
```
...
git clone https://github.com/SciX-Skill/quantum-skill-skill.git
cd quantum-skill-skill
...
https://github.com/SciX-Skill/quantum-skill-skill/issues
